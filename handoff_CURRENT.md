...
- Test `industrieakte` with a real technical/industrial Ausstellung candidate such as the WF/Röhren material before treating it as production-ready.
...
- Local dirt at this checkpoint is expected to be limited to untracked `theme2.json` and `iss-exhibition-composition-add.md` unless a later agent intentionally stages them.
