...
- Continue Atlas cleanup from `docs/architecture/atlas-static-map-implementation-plan.md`: split the remaining interactive Atlas runtime place/filter UI and detail/story/relation rendering into focused modules.
