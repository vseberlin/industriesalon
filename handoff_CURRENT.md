...
- Continue Atlas cleanup from `docs/architecture/atlas-static-map-implementation-plan.md`: add fullscreen and kiosk modes as Atlas layout states, not separate apps.
