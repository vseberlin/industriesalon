...
function iss_register_map_place_entity(WP_Post $post): array
{
    ...
    $place = [
        ...
        'construction_period' => (string) iss_register_get_meta_value($post_id, 'construction_period', ''),
        'original_name' => (string) iss_register_get_meta_value($post_id, 'original_name', ''),
        'monument_status' => (string) iss_register_get_meta_value($post_id, 'monument_status', ''),
        'monument_record_url' => (string) iss_register_get_meta_value($post_id, 'monument_record_url', ''),
        ...
        'potential_note' => (string) iss_register_get_meta_value($post_id, 'potential_note', ''),
        'risk_note' => (string) iss_register_get_meta_value($post_id, 'risk_note', ''),
    ...
    if (function_exists('iss_graph_enrich_register_place_entity')) {
        $place = iss_graph_enrich_register_place_entity($place, $post);
    }
