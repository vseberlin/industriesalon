...
function iss_register_build_summary_places_payload(array $query_args = [], array $fields = []): array
{
    return [
        'places' => iss_register_get_summary_places_contracts($query_args, $fields),
        'meta' => iss_register_get_meta_contract(),
    ];
}
