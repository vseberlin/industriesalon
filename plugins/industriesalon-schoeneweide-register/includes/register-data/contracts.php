...
function iss_register_build_place_detail_contract_data(array $place): array
{
    ...
    return [
        ...
        'graph_entity_id' => isset($place['graph_entity_id']) ? (int) $place['graph_entity_id'] : 0,
        'owner' => isset($place['owner']) ? (string) $place['owner'] : '',
        'operator' => isset($place['operator']) ? (string) $place['operator'] : '',
        'developer' => isset($place['developer']) ? (string) $place['developer'] : '',
        'tenant' => isset($place['tenant']) ? (string) $place['tenant'] : '',
        ...
        'potential_note' => isset($place['potential_note']) ? (string) $place['potential_note'] : '',
        'risk_note' => isset($place['risk_note']) ? (string) $place['risk_note'] : '',
        ...
        'names' => isset($place['names']) && is_array($place['names']) ? array_values($place['names']) : [],
        'organizations' => isset($place['organizations']) && is_array($place['organizations']) ? array_values($place['organizations']) : [],
        'people' => isset($place['people']) && is_array($place['people']) ? array_values($place['people']) : [],
