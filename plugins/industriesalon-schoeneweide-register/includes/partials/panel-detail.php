...
<section class="iss-register-panel" data-panel="detail" aria-labelledby="iss-register-panel-detail">
  ...
  <div class="iss-register-detail-linked-grid">
    <article class="iss-register-detail-section">
      <h4>Organisationen im Zusammenhang</h4>
      <ul class="iss-register-detail-relations" data-detail-organizations>
        <li>—</li>
      </ul>
    </article>

    <article class="iss-register-detail-section">
      <h4>Personen im Zusammenhang</h4>
      <ul class="iss-register-detail-relations" data-detail-people>
        <li>—</li>
      </ul>
    </article>
  </div>
