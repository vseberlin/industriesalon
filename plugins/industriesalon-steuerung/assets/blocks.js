  ...
  function fieldInspector(props) {
    return el(
      ...
      el(
        ...
        el(TextControl, {
          label: 'CSS-Klasse',
          value: props.attributes.cssClass,
          onChange: function (value) { props.setAttributes({ cssClass: value }); }
        }),
        el(TextControl, {
          label: 'Link-Anhang',
          value: props.attributes.hrefSuffix,
          onChange: function (value) { props.setAttributes({ hrefSuffix: value }); }
        })
      )
    );
  }
      ...
      return el(
        ...
        el(
          ...
          el(
            ...
            el(ToggleControl, {
              label: 'Kontaktzeile zeigen',
              checked: !!props.attributes.show_contact,
              onChange: function (value) { props.setAttributes({ show_contact: value }); }
            }),
            el(ToggleControl, {
              label: 'Telefon zeigen',
              checked: !!props.attributes.show_contact_phone,
              onChange: function (value) { props.setAttributes({ show_contact_phone: value }); }
            }),
            el(ToggleControl, {
              label: 'E-Mail zeigen',
              checked: !!props.attributes.show_contact_email,
              onChange: function (value) { props.setAttributes({ show_contact_email: value }); }
            }),
            el(ToggleControl, {
              label: 'Buchungs-E-Mail zeigen',
              checked: !!props.attributes.show_contact_booking_email,
              onChange: function (value) { props.setAttributes({ show_contact_booking_email: value }); }
            }),
            el(ToggleControl, {
              label: 'Ansprechperson zeigen',
              checked: !!props.attributes.show_contact_person,
              onChange: function (value) { props.setAttributes({ show_contact_person: value }); }
            }),
            el(ToggleControl, {
              label: 'Website zeigen',
              checked: !!props.attributes.show_contact_website,
              onChange: function (value) { props.setAttributes({ show_contact_website: value }); }
            })
          ),
          el(
            PanelBody,
