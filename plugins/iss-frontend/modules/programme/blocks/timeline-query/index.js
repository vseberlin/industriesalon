              ...
              el(
                ...
                ToggleControl
                  ? el(ToggleControl, {
                      ...
                      checked: !Object.prototype.hasOwnProperty.call(attrs, 'showRecurringNote') || !!attrs.showRecurringNote,
                      onChange: function (value) {
                        setAttributes({ showRecurringNote: !!value });
                      },
                    })
                  : null,
                ToggleControl
                  ? el(ToggleControl, {
                      label: 'Nächster Termin in Karten anzeigen',
                      checked: !!attrs.showNextOccurrenceLabel,
                      onChange: function (value) {
                        setAttributes({ showNextOccurrenceLabel: !!value });
                      },
                    })
                  : null,
                SelectControl
                  ...
                  : null,
                attrs.renderMode === 'cards' && ToggleControl
                  ? el(ToggleControl, {
                      label: 'Show card images',
                      checked: !Object.prototype.hasOwnProperty.call(attrs, 'showCardImage') || !!attrs.showCardImage,
                      onChange: function (value) {
                        setAttributes({ showCardImage: !!value });
                      },
                    })
                  : null,
                attrs.renderMode === 'cards' && ToggleControl
                  ? el(ToggleControl, {
                      label: 'Show card summary',
                      checked: !Object.prototype.hasOwnProperty.call(attrs, 'showCardSummary') || !!attrs.showCardSummary,
                      onChange: function (value) {
                        setAttributes({ showCardSummary: !!value });
                      },
                    })
                  : null,
                ToggleControl
