...
- The graph entity hygiene guardrail now exists as the read-only `wp iss-graph entity-hygiene-audit` command. The next refactor move should review its output and leave merge/reassign behavior until curator decisions are clear.
